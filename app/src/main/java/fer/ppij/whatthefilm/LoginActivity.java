...
public class LoginActivity extends AppCompatActivity {
    ...
    private void handleSignInResult(Task<GoogleSignInAccount> completedTask) {
        try {
            ...
            Log.w("LoginActivtiy", "signInResult:failed code=" + e.getStatusCode());
            Toast.makeText(LoginActivity.this, "error " + e.getStatusCode() + " " + e.getLocalizedMessage() + " " + e.getMessage(),
                    Toast.LENGTH_SHORT).show();        }
    }
    @Override
